...
export const buildSeoBlogPrompt = (suggestion: SeoSuggestion) => {
  ...
  return [
    ...
    '- Đồng thời trả imagePrompts gồm đúng 3 mục: filename, alt, title, caption, prompt. Trong đó prompt cho ảnh hero/ảnh đại diện bài viết blog phải mô tả rõ bối cảnh, sản phẩm, phong cách ecommerce/lifestyle nam Việt Nam; tất cả prompt phải yêu cầu tỉ lệ 3:2, không chữ trên ảnh, sản phẩm rõ.',
    `- Gợi ý prompt ảnh 1: Hero/ảnh đại diện đầu bài cho "${suggestion.keyword}", nam Việt Nam mặc đồ URSport trong bối cảnh đời thường hoặc tập luyện, ánh sáng tự nhiên, sản phẩm rõ, không chữ trên ảnh, tỉ lệ 3:2.`,
